  ...
  return (
    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M18 31c-1-.8-14-9.5-14-17.5A8.5 8.5 0 0 1 18 7.5 8.5 8.5 0 0 1 32 13.5C32 21.5 19 30.2 18 31z"
        stroke="#C4978F" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
    </svg>
  );
}
  ...
  return (
    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M18 4l3.8 8.5 9.2 1-6.8 6.4 2 9.1L18 24.5 9.8 29l2-9.1L5 13.5l9.2-1z"
        stroke="#C9A55A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
    </svg>
  );
}
...
function IconCamera() {
  return (
    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="4" y="10" width="28" height="20" rx="3" stroke="#8B9E89" strokeWidth="1.5" strokeLinecap="round"/>
      <circle cx="18" cy="20" r="5" stroke="#8B9E89" strokeWidth="1.5"/>
      <path d="M13 10l2-4h6l2 4" stroke="#8B9E89" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  );
}
  ...
  return (
    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M18 4 L31 9 L31 19 C31 26 18 32 18 32 C18 32 5 26 5 19 L5 9 Z"
        stroke="#C4978F" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
      <path d="M12 18l4 4 8-8" stroke="#C4978F" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
function IconCompass() {
  return (
    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="18" cy="18" r="13" stroke="#C9A55A" strokeWidth="1.5"/>
      <path d="M18 5v3M18 28v3M5 18h3M28 18h3" stroke="#C9A55A" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M23 13l-4 9-4-9 4-4z" stroke="#C9A55A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
    </svg>
  );
}
...
const promises = [
  ...
  { Icon: IconStar, title: "Toddler-Tested", body: "Our daughter was 18 months on her first trip. These ratings come from lived experience." },
...
export default function HomePage() {
  return (
    <div className="pt-16 bg-[#FAF8F4]">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-16 items-center">
            ...
            <div className="max-w-2xl">
              <p
                className="tracking-luxury text-[#8B9E89] text-xs uppercase mb-6"
              ...
              <h1
                className="font-display text-[clamp(3rem,7vw,5.5rem)] leading-[1.05] font-light text-[#2C1F1A] mb-8"
              >
                Real Magic.{" "}
                <em className="display-italic text-[#C4978F]">Real Toddler</em>{" "}
                Chaos.
              </h1>

              <p className="text-[#6B5248] text-lg leading-relaxed mb-10 max-w-lg">
              ...
              <div className="flex flex-wrap gap-3 mb-10">
                {["🏨 Deluxe Only", "👶 Toddler Tested", "📸 Our Real Photos"].map((p) => (
                  <span
                    key={p}
                    className="bg-[#F5EDEB] text-[#A67B73] text-xs font-medium px-4 py-2 rounded-full border border-[#E8DAD7] tracking-wide"
                  >
                    {p}
                  </span>
                ))}
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  href="/resorts"
                  className="pixie-hover-gold bg-[#C9A55A] hover:bg-[#b89248] text-white font-medium px-8 py-3.5 rounded-full text-sm tracking-wide transition-colors"
                >
                  Our Resort Rankings
                </Link>
                <Link
                  href="/tips/disney-world-toddler-packing-list"
                  className="pixie-hover border border-[#C4978F] text-[#A67B73] hover:bg-[#F5EDEB] font-medium px-8 py-3.5 rounded-full text-sm tracking-wide transition-colors"
                >
                  Free Packing List
                </Link>
              </div>
            ...
            <div className="relative hidden lg:block h-[520px]">
              ...
              >
                ...
                <p className="text-center text-xs text-[#6B5248] mt-3 font-display italic">Animal Kingdom Lodge, 2024</p>
              </div>
              ...
              >
                ...
                <p className="text-center text-xs text-[#6B5248] mt-3 font-display italic">Polynesian Village, 2024</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#EDF1EC] py-20 px-6">
        <div className="max-w-5xl mx-auto text-center">

          {/* Section label */}
          <p className="tracking-luxury text-[#8B9E89] text-xs uppercase mb-4">
            Our Commitment
          </p>
          <h2 className="font-display text-[clamp(2rem,4vw,3.2rem)] font-light text-[#2C1F1A] mb-3">
            A Family Promise
          </h2>
          <div className="divider-rose mx-auto mb-12" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-6 mb-14">
            {promises.map(({ Icon, title, body }) => (
              <div
                key={title}
                className="pixie-hover flex flex-col items-center gap-3 bg-white rounded-2xl p-6 border border-[#E8DAD7]"
              >
                <Icon />
                <h3 className="font-display text-base font-semibold text-[#2C1F1A] leading-snug">
                  {title}
                </h3>
                <p className="text-[#6B5248] text-xs leading-relaxed">{body}</p>
              </div>
            ))}
          </div>

          {/* Signature sign-off — Great Vibes gives it a handwritten feel */}
          <p className="text-[#6B5248] text-sm mb-3 tracking-wide">
            With love from our family to yours,
          </p>
          <p
            className="font-signature text-[#C4978F] text-5xl"
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-14">
            <p className="tracking-luxury text-[#8B9E89] text-xs uppercase mb-4">Honest Rankings</p>
            <h2 className="font-display text-[clamp(2rem,4vw,3.2rem)] font-light text-[#2C1F1A] mb-3">
              Walt Disney World Deluxe Resorts
            </h2>
            <div className="divider-rose mx-auto mb-4" />
            <p className="text-[#6B5248] max-w-md mx-auto text-sm leading-relaxed">
          ...
          <Link
            ...
            className="pixie-hover group block bg-white rounded-3xl overflow-hidden border border-[#E8DAD7] mb-6"
          >
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] items-stretch">
              <div className="p-10 flex flex-col justify-center">
                <div className="flex items-center gap-3 mb-4">
                  <span className="bg-[#F7EDD8] text-[#C9A55A] text-xs font-semibold px-3 py-1 rounded-full border border-[#C9A55A]/30 tracking-wide">
                    #1 Our Top Pick
                  </span>
                  <span className="text-[#8B9E89] text-xs border border-[#E8DAD7] px-3 py-1 rounded-full">
                    Deluxe
                  </span>
                </div>
                <h3 className="font-display text-4xl font-light text-[#2C1F1A] mb-3 group-hover:text-[#A67B73] transition-colors">
                  {resorts[0].title}
                </h3>
                <p className="text-[#6B5248] leading-relaxed mb-6 max-w-lg">
                  {resorts[0].description}
                </p>
                <div className="flex items-center gap-6 mb-6">
                  <div className="text-center">
                    <p className="font-display text-3xl text-[#C9A55A]">{resorts[0].toddlerScore}</p>
                    <p className="text-xs text-[#6B5248] tracking-wide">Toddler Score</p>
                  </div>
                  <div className="w-px h-10 bg-[#E8DAD7]" />
                  <div className="text-center">
                    <p className="font-display text-3xl text-[#C4978F]">{resorts[0].ourRating}/5</p>
                    <p className="text-xs text-[#6B5248] tracking-wide">Our Rating</p>
                  </div>
                </div>
                <span className="text-[#C9A55A] text-sm font-medium tracking-wide group-hover:underline">
                  Read Full Review →
                </span>
              </div>
              <div className="bg-[#F5EDEB] min-h-[280px] flex items-center justify-center p-6">
          ...
          <Link
            ...
            className="pixie-hover group block bg-white rounded-3xl overflow-hidden border border-[#E8DAD7] mb-10"
          >
            <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] items-stretch">
              <div className="bg-[#EDF1EC] min-h-[280px] flex items-center justify-center p-6">
              ...
              <div className="p-10 flex flex-col justify-center">
                <div className="flex items-center gap-3 mb-4">
                  <span className="bg-[#EDF1EC] text-[#8B9E89] text-xs font-semibold px-3 py-1 rounded-full border border-[#8B9E89]/30 tracking-wide">
                    #2 Best for Toddlers
                  </span>
                </div>
                <h3 className="font-display text-4xl font-light text-[#2C1F1A] mb-3 group-hover:text-[#A67B73] transition-colors">
                ...
                <div className="flex items-center gap-6 mb-6">
                  <div className="text-center">
                    <p className="font-display text-3xl text-[#C9A55A]">{resorts[1].toddlerScore}</p>
                    <p className="text-xs text-[#6B5248] tracking-wide">Toddler Score</p>
                  </div>
                  <div className="w-px h-10 bg-[#E8DAD7]" />
                  <div className="text-center">
                    <p className="font-display text-3xl text-[#C4978F]">{resorts[1].ourRating}/5</p>
                    <p className="text-xs text-[#6B5248] tracking-wide">Our Rating</p>
                  </div>
                </div>
                <span className="text-[#C9A55A] text-sm font-medium tracking-wide group-hover:underline">
          ...
          <div className="text-center mt-12">
            <Link
              href="/resorts"
              className="pixie-hover inline-flex items-center gap-2 border border-[#C4978F] text-[#A67B73] hover:bg-[#F5EDEB] font-medium px-8 py-3.5 rounded-full text-sm tracking-wide transition-colors"
            >
              View All Reviews
            </Link>
          </div>
      ...
      <section className="bg-[#F5EDEB] py-20 overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 items-center">
            ...
            <div className="relative mb-12 lg:mb-0">
              ...
              >
                ...
                <p className="text-center text-xs text-[#6B5248] mt-2 font-display italic">Magic Kingdom, 2024</p>
              </div>
            </div>

            {/* Text column — indented to create overlap feeling on large screens */}
            <div className="lg:pl-16">
              <p className="tracking-luxury text-[#8B9E89] text-xs uppercase mb-4">Our Story</p>
              <h2 className="font-display text-[clamp(2rem,4vw,3rem)] font-light text-[#2C1F1A] mb-2">
                Just a Real Family
              </h2>
              <h2 className="font-display text-[clamp(2rem,4vw,3rem)] display-italic text-[#C4978F] mb-6">
                Who Loves Disney
              </h2>
              <div className="divider-rose mb-8" />

              <p className="text-[#6B5248] leading-relaxed mb-4">
              ...
              <p className="text-[#6B5248] leading-relaxed mb-8">
                We started visiting Deluxe resorts when our daughter was 18 months old. Every review on
              ...
              <ul className="space-y-3 mb-10">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3">
                    <span className="text-[#C4978F] text-lg mt-0.5">✦</span>
                    <span className="text-[#6B5248] text-sm leading-relaxed">{item}</span>
                  </li>
                ))}
              </ul>
              ...
              <Link
                href="/about"
                className="pixie-hover inline-flex items-center gap-2 bg-[#C4978F] hover:bg-[#A67B73] text-white font-medium px-8 py-3.5 rounded-full text-sm tracking-wide transition-colors"
              >
                Read Our Story →
              </Link>
            </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <p className="tracking-luxury text-[#8B9E89] text-xs uppercase mb-4">Begin Here</p>
            <h2 className="font-display text-[clamp(2rem,4vw,3.2rem)] font-light text-[#2C1F1A]">
              Start Planning
            </h2>
          ...
          <Link
            ...
            className="pixie-hover group block bg-[#F7EDD8] border border-[#C9A55A]/30 rounded-3xl p-10 sm:p-12 mb-6"
          >
            <p className="tracking-luxury text-[#C9A55A] text-xs uppercase mb-4">Complete Guide</p>
            <h3 className="font-display text-3xl sm:text-4xl font-light text-[#2C1F1A] mb-4 group-hover:text-[#A67B73] transition-colors max-w-2xl">
              The Complete Guide to Disney World with a Toddler
            </h3>
            <p className="text-[#6B5248] mb-6 max-w-xl leading-relaxed">
